...
st.text("""Number of Buildings by City (Bar Chart) This visualization will display the total number of buildings in each city. 
The bar chart will allow us to quickly identify which cities have the most or fewest buildings, providing an overview of building distribution across different locations.""")
