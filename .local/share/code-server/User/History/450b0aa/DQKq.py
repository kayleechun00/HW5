...
st.text("""Number of Buildings by City (Bar Chart):
...
By visualizing the data over time, we can observe trends in construction activity and understand how the total building area has evolved throughout the years. 
